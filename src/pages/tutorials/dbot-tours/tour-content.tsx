...
export const DBOT_ONBOARDING = [
    {
        ...
        content: (
            <TourSteps
                label={<Localize i18n_default_text='Get started on D-Mecca' />}
                content={[
                    <>
...
export const DBOT_ONBOARDING_MOBILE: TMobileTourConfig[] = [
    {
        header: <Localize i18n_default_text='Get started on D-Mecca' />,
        content: [
...
export const getTourDialogInfo = (is_mobile: boolean) => {
    return is_mobile ? (
        <Localize
            ...
            i18n_default_text='Here’s a quick guide on how to use D-Mecca on the go.'
        />
    ) : (
        <Localize
...
export const onboarding_tour_header = (
    <Localize key='onboarding-tour-header' i18n_default_text='Get started on D-Mecca' />
);
